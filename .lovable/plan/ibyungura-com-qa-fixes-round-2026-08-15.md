...
Add a live "3 / 12"  based on the image he/she uploaded counter on the mobile carousel that updates as you swipe, and a photo count chip on the desktop gallery. Design stays exactly as it is — only the existing static "N photos" chip becomes a live index.
