...
| Tier 1 | RWF 20,000 / month | up to 50 | analytics dashboard |
| Tier 2 | RWF 50,000 / month | unlimited | analytics + priority support |
...
- **Analytics dashboard** (Tier 1 and 2 only): views per listing from a new view counter, plus totals by status, category and city. Free agents see a locked preview card.
- **Verified badge**: shown on the agent profile page, agent cards in Find an Agent, and property cards.
